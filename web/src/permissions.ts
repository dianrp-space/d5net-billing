...
export const PERMISSION_PAGE_MAP: Record<string, string[]> = {
  ...
  network: ["clusters", "routers", "subscriptions", "ipam", "odp", "vouchers"],
  ...
  settings: ["branding", "isolir-template", "notifications", "roles", "users", "backup", "webhooks", "payment-gw", "messaging-gw", "sla-report"],
