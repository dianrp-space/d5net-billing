...
export const PERMISSION_PAGE_MAP: Record<string, string[]> = {
  "*": ["*"],
  dashboard: ["dashboard"],
  customers: ["customers", "leads", "resellers", "sla-report", "coverage"],
  ...
  settings: ["general", "isolir-template", "jobs", "notifications", "roles", "users", "backup", "webhooks", "payment-gw", "messaging-gw", "sla-report"],
