...
`ISOLIR_HTTP_ADDR` = captive isolir (DST-NAT ke IP:8090). Forward port 8090 sampai ke proses API (firewall / CHR / WG). Nginx situs biasa (80/443) tidak perlu diubah untuk isolir.
